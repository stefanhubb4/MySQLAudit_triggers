...
CREATE PROCEDURE audit.proc_create_after_update_trigger(IN full_original_table_name VARCHAR(255), IN full_audit_table_name VARCHAR(255))
BEGIN
    ...
    DECLARE stmt VARCHAR(2000); -- Increased the length to accommodate both inserts
    ...
    SELECT stmt; -- Print the prepared statement
END //
